...
class intro01 extends StatefulWidget {
  final Image? Urlimg;
  final Image? Title;
  final Image? Subtitle;
  const intro01({super.key, this.Urlimg, this.Title, this.Subtitle});

  @override
  State<intro01> createState() => _intro01();
}

class _intro01 extends State<intro01> {
  @override
  void initState() {}
  @override
            ...
            child: SafeArea(
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.popAndPushNamed(context, AppRoute.register);
                    },
                    child: CustomOutline(
                      strokeWidth: 3,
                      radius: 20,
